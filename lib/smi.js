...
module.exports = {
    ...
    generate: function(data) {
        ...
        captions.forEach(function (caption) {
            ...
            SAMI_BODY += SAMI.lineTemplate.replace('{startTime}', Math.floor(caption.startTimeMicro / 1000)).replace('{text}', module.exports.renderMacros(caption.text)) + '\n';
        });
    ...
    renderMacros: function(data) {
        return data.replace(/\{break\}/g, '<br>').replace(/\{italic\}/g, '<i>').replace(/\{end-italic\}/g, '</i>');
    }
